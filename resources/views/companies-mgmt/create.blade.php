    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading text-center text-danger text-bold">NEW COMPANY PORTAL
                        <a href="{{ url('company-management') }}"><i class="fa fa-arrow-left btn btn-primary pull-right"></i></a>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('company-management.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('company_email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="company_email" type="text" class="form-control" name="company_email" value="{{ old('company_email') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('company_phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="company_phone" type="text" class="form-control" name="company_phone" value="{{ old('company_phone') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('company_website') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="company_website" type="text" class="form-control" name="company_website" value="{{ old('company_website') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('no_of_employees') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no_of_employees" type="text" class="form-control" name="no_of_employees" value="{{ old('no_of_employees') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('services') ? ' has-error' : '' }}">
                            <label for="zip" class="col-md-4 control-label">Services</label>

                            <div class="col-md-6">
                                <input id="services" type="text" class="form-control" name="services" value="{{ old('services') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <img id="output" width="50" height="50" style="border-radius: 50px; border:2px solid silver" class="rounded-pill">
                            </div>
                        </div>
                        <div class="form-group">
